...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |--------------------+------+------+------+------+------+------+------+------+------+------+------+-------------|------|
   * |ADJUST| LOWER|      |  ALt ||||||||  GUI | Space|      ||||||||      | Bksp | LOWER||||||||  ALt | Down |  Up  | Right|
   * ,---------------------------------------------------------------------------------------------------------------.------.
   */
  [_QWERTY] = LAYOUT( \
     ...
     ADJUST,  LOWER  ,  _______, KC_LALT,          LNG_TOG, KC_SPC, _______,       _______,KC_BSPC, LOWER,            KC_RALT, KC_DOWN, KC_UP,   KC_RGHT  \
  ),
