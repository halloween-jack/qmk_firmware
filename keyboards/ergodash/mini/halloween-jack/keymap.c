...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LCTL, KC_LGUI, RAISE, WINDOW,             KC_LALT,   KC_SPC , MOUSE,        KC_RALT,KC_BSPC, KC_ENT,            LOWER, KC_DOWN, KC_UP,   KC_RGHT  \
  ),
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_LCTL, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_LCBR,                        KC_RCBR, KC_TILD, KC_MINS, KC_EQL, KC_LBRC, KC_RBRC, KC_DQT , \
    KC_LSFT, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_SPC ,                        KC_ENT , KC_N,    KC_M,    KC_LT,   KC_GT,   KC_QUES, KC_RSFT, \
    KC_LCTL, KC_LGUI, RAISE, EISU,             LOWER,   KC_SPC , KC_DEL,        KC_BSPC,KC_ENT , RAISE,            LOWER, KC_PGDN, KC_PGUP, KC_END   \
  ),
  ...
  */
  [_RAISE] = LAYOUT(
    ...
    KC_LCTL, KC_F11 , RAISE,  EISU,             LOWER,   KC_SPC , KC_DEL,        KC_BSPC,KC_ENT , RAISE,            LOWER, KC_PGDN, KC_PGUP, KC_END   \
    ),
